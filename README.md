...
Starter using Vite + React + TypeScript + Tailwind (daisyUI)
...
```shell
[cp or mv] .env.local.example .env.local
yarn
yarn dev
```
...
- [x] install and set up [TailwindCSS/JIT](https://github.com/tailwindlabs/tailwindcss-jit)
